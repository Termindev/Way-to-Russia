...
- **Format:** Fully Online (Used to be, check [scholarships](/scholarships) for more information about applying to SpbU)
...
## [Grant Competition by CU](https://apply.cu.ru/)

- **Format:** Fully Online
- **Subjects:** Maths and Computer science or Design
- **Language:** Russian.
- **Prize:** A partial or 100% tuition fee waiver.
- **Grades that can participate:** ?
- **Application dates:**
  - Application period: Check on website

## [Siberian Federal District International Olympiad)](https://olymp-sibir.nstu.ru/international/en)

- **Format:** Fully Online
- **Subjects:** Mathematics, Physics, Computer Science, Engineering, Natural Sciences (varies by year)
